...
var fuzzy = new FuzzyComparator(['Open New' ,'open website in new window','paste','Open a File','Open Another File', 'Open File','File Open','File Save','Exit','Delete File','open pop']);
console.log(fuzzy.fuzzyCompareAndRank('open a fule'));
//console.log(fuzzy.fuzzyCompare('open File','delete file'));